function FormInput({ id, label, error, endAdornment, className = "", ...inputProps }) {
  return (
    <div className={className}>
      ...
      <div className="relative flex">
        <input
          id={id}
          className={`min-h-10 w-full flex-1 rounded-lg border bg-surface px-3 py-2.5 text-sm text-ink shadow-inset outline-none ${endAdornment ? "pr-11" : ""} ${error ? "border-danger" : "border-border"}`}
